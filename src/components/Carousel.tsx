...
const Carousel = () => {
    return (
        <div className="h-full flex flex-row">
            <div className="w-2/3 bg-[#a38486] flex items-center">
                ...
                <div className="absolute w-2/3 text-white flex flex-col items-center">
                    ...
                    <button className="flex flex-row mt-[40px] rounded-md border px-5 pt-1 pb-2 hover:bg-[#ffffff18] transition-all duration-500">
            ...
            <div className='flex flex-col w-1/3'>
                <div className='w-full bg-[#a38486] flex items-center text-white'>
                    ...
                    <div className="absolute w-1/3 flex flex-col items-center">
                        ...
                        <button className="flex flex-row mt-[10px] rounded-md border border-transparent hover:border-white px-5 pt-1 pb-2 transition-all duration-200">
                            <span className="text-2xl font-semibold">Learn more</span>
                        </button>
                    </div>
                </div>

                <div className='w-full bg-[#d89fa1] flex items-center text-white'>
